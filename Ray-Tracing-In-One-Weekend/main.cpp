...
int main()
{
    ...
    // Camera
    const camera camera(point3(-2, 2, 1), point3(0, 0, -1), vec3(0, 1, 0), 40, aspect_ratio);

    // Render
    std::ofstream output_image("output_image_from_11_2(HIGH_20_Positioning and Orienting the Camera).ppm");
